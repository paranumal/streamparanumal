...
./BS7 -m $mode -nx 160 -ny 80 -nz 80 -p 1
./BS7 -m $mode -nx  80 -ny 80 -nz 40 -p 2
./BS7 -m $mode -nx  80 -ny 40 -nz 40 -p 3
./BS7 -m $mode -nx  40 -ny 40 -nz 40 -p 4
./BS7 -m $mode -nx  40 -ny 40 -nz 20 -p 5
./BS7 -m $mode -nx  40 -ny 20 -nz 20 -p 6
./BS7 -m $mode -nx  30 -ny 20 -nz 20 -p 7
