...
mpirun -np 1 BS6 -m $mode -nx 126 -ny 126 -nz 126 -p 1
...
mpirun -np 1 BS6 -m $mode -nx  18 -ny  18 -nz  18 -p 9
mpirun -np 1 BS6 -m $mode -nx  16 -ny  16 -nz  16 -p 10
mpirun -np 1 BS6 -m $mode -nx  15 -ny  15 -nz  15 -p 11
mpirun -np 1 BS6 -m $mode -nx  14 -ny  14 -nz  14 -p 12
mpirun -np 1 BS6 -m $mode -nx  13 -ny  13 -nz  13 -p 13
mpirun -np 1 BS6 -m $mode -nx  12 -ny  12 -nz  12 -p 14
mpirun -np 1 BS6 -m $mode -nx  11 -ny  11 -nz  11 -p 15
